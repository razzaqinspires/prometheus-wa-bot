// services/menu/MenuSession.js (V2.3 - Standardized Session Object)
// Perbaikan: Menambahkan properti 'command' ke constructor untuk memastikan
// semua objek sesi memiliki struktur yang konsisten.
...
export default class MenuSession {
    constructor(context) {
        ...
        // [PERBAIKAN UTAMA] Definisikan nama perintah untuk sesi ini.
        this.command = 'menu';
    ...
    async start() {
        ...
        const messagePayload = photoBuffer
        ? { image: photoBuffer, caption: initialText }
        : { text: initialText };
        ...
        const userPrefs = this.bot.stateManager.state.registeredUsers[this.sender]?.menuPrefs || {};
        if (userPrefs.widgets?.header || userPrefs.widgets?.cognitive || userPrefs.widgets?.activity) {
